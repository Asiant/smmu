...
mysql_select_db("sommudatabase", $con);
		$message=$_POST['message'];
		$username=$_POST['username'];
		mysql_query("INSERT INTO message(message, username)VALUES('$message', '$username')");
}
...
<input name="username" type="text" id="texta" value=<?php echo $username; ?>/>
<div class="refresh">
<?php
$con = mysql_connect("localhost","root","");
if (!$con)
...
while($row = mysql_fetch_array($result))
  {
  echo '<p>'.'<span>'.$row['username'].'</span>'. '&nbsp;&nbsp;' . $row['message'].'</p>';
  }
