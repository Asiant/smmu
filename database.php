<?php
/*
	This is the database for the JSON AJAX Driven Chat tutorial.
*/
...
//password = The password to connect to the database.
  function db_connect($server = 'localhost', $username = 'root', $password = '', $database = 'sommudatabase', $link = 'db_link') {
    global $$link;
